    ...
    return (
        <View>
            ...
            <View style={styles.entriesCount} >
                ...
                <Text>
                    Total entries: {wards?.filter((item) => (item.toLowerCase().includes(searchedQuery.toLowerCase()))).length}
                </Text>
                <View style={{ alignItems: 'center', marginBottom: -10 }} >

                    <Text style={{ color: 'black', fontSize: 22 }} >Please select a ward</Text>
                </View>
            ...
            <View style={{ marginBottom: 270 }}>
                ...
                <SafeAreaView  >
                    <FlatList
                        ...
                        data={wards?.filter((item) => (item.toLowerCase().includes(searchedQuery.toLowerCase())))}
                        renderItem={({ item }) => {
                            return (
                                <TouchableRipple

                                    onPress={() => navigation.push("WardTabsNavigator", { userWard: item })}
                                        ...
                                        <View style={{ margin: 5 }} >
                                            <View style={styles.listItem} >
                                                ...
                                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                                                    ...
                                                    <MaterialCommunityIcons name="chevron-right" size={30} style={{ marginRight: 15, marginTop: 5 }} />
